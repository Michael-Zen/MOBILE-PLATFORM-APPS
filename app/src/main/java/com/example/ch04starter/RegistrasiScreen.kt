...
// ============================================================================
// Pertemuan 4 — RegistrasiScreen (soal #3 di Tugas Pertemuan 4)
//
...
// [x] 3a. `nama` tidak kosong
// [x] 3b. `email` mengandung karakter "@" (validasi sederhana, tidak perlu regex penuh)
// [x] 3c. `password` minimal 8 karakter
// [x] 3d. `konfirmasiPassword` sama persis dengan `password`
// [x] 3e. Gabungkan keempatnya jadi satu `derivedStateOf<Boolean>` bernama
